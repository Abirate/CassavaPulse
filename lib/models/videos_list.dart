...
class VideosList {
    ...
    PageInfo pageInfo = PageInfo(resultsPerPage: 0, totalResults: 0);
    ...
    factory VideosList.fromJson(Map<String, dynamic> json) => VideosList(
        ...
        json["etag"],
        json["nextPageToken"],
        List<VideoItem>.from(json["items"].map((x) => VideoItem.fromJson(x))),
...
class Thumbnails {
    ...
    factory Thumbnails.fromJson(Map<String, dynamic> json) => Thumbnails(
        ...
        // Modified
        standard: json["standard"] != null ? Default.fromJson(json["standard"]) : Default(/* default values */),
        maxres: json["maxres"] != null ? Default.fromJson(json["maxres"]) : Default(/* default values */),
